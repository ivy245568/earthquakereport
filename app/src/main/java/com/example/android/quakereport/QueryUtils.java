...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            Log.d(TAG, "size of featureArray: " + featureArray.length());
            for (int i = 0; i < featureArray.length(); i++) {
                JSONObject featureJSONObject = featureArray.getJSONObject(i);
                JSONObject propertiesJSONObject = featureJSONObject.getJSONObject("properties");
                Earthquake earthquake = new Earthquake(propertiesJSONObject.getString("place"), propertiesJSONObject.getDouble("mag"), propertiesJSONObject.getLong("time"), propertiesJSONObject.getString("url"));
    ...
    public static class Earthquake {
        ...
        Long date;
        String url;
        public Earthquake(String location, Double level, Long date, String url) {
